...
export function saveData(moodEntriesOrData, sleepEntries = []) {
  const data = Array.isArray(moodEntriesOrData)
    ? { moodEntries: moodEntriesOrData, sleepEntries }
    : {
      moodEntries: moodEntriesOrData?.moodEntries || [],
      sleepEntries: moodEntriesOrData?.sleepEntries || [],
    }
